      ...
      <Card className="w-full bg-gradient-to-br from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-800/50 border-0 shadow-lg">
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <div className="h-6 w-40 bg-gradient-to-r from-slate-200 to-slate-300 dark:from-slate-700 dark:to-slate-600 rounded-lg animate-pulse"></div>
        ...
        <CardContent>
          <div className="space-y-4">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="flex items-center space-x-4 p-4 rounded-xl bg-slate-100/50 dark:bg-slate-800/50 animate-pulse">
      ...
      <Card className="w-full bg-gradient-to-br from-red-50 to-orange-50/50 dark:from-red-950/20 dark:to-orange-950/20 border-red-200/50 dark:border-red-800/50">
        <CardContent className="pt-6">
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Check your connection and try again</p>
            <Button 
              variant="outline" 
              className="mt-4"
      ...
      <CardContent className="pt-0">
        {recentDocuments.length === 0 ? (
          ...
          >
            ...
            <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">No documents yet</h4>
          ...
          <div className="space-y-3">
              ...
              {recentDocuments.map((doc, index) => (
                ...
                >
                  <div className="relative p-4 rounded-xl bg-gradient-to-r from-white via-slate-50/50 to-white dark:from-slate-800/50 dark:via-slate-700/20 dark:to-slate-800/50 border border-slate-200/50 dark:border-slate-700/50 hover:border-blue-200 dark:hover:border-blue-700/50 hover:shadow-md transition-all duration-300 cursor-pointer">
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-50/0 via-purple-50/0 to-blue-50/0 group-hover:from-blue-50/20 group-hover:via-purple-50/10 group-hover:to-blue-50/20 dark:group-hover:from-blue-950/10 dark:group-hover:via-purple-950/5 dark:group-hover:to-blue-950/10 rounded-xl transition-all duration-300"></div>
                    
                    <div className="relative flex items-center gap-4">
                      {/* File Icon */}
                      <div className="flex-shrink-0">
                        <div className="w-12 h-12 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 rounded-xl flex items-center justify-center text-2xl shadow-sm group-hover:shadow-md transition-shadow">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-4">
                          <div className="min-w-0 flex-1">
                            <h4 className="font-semibold text-gray-900 dark:text-gray-100 truncate text-sm group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors">
                              {doc.filename}
                            </h4>
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              <Badge 
                                variant="secondary" 
                                className={`${getDepartmentColor(doc.department)} text-xs px-2 py-1 rounded-full border-0`}
                              >
                                {doc.department}
                              </Badge>
                              <Badge 
                                variant="outline" 
                                className={`${getStatusColor(doc.status)} text-xs px-2 py-1 rounded-full border`}
                              >
                                {doc.status}
                              </Badge>
                            </div>
                          ...
                          <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                            ...
                            {doc.status === 'COMPLETED' && (
                              <Button
                                variant="ghost"
                                size="sm"
                                className="h-8 px-3 text-xs text-green-600 hover:text-green-700 hover:bg-green-50 dark:hover:bg-green-950/20"
                              >
            ...
            {recentDocuments.length >= 5 && (
              <motion.div
                ...
                className="pt-4 text-center border-t border-slate-200/50 dark:border-slate-700/50"
              >
                <Button
                  variant="outline"
                  asChild
